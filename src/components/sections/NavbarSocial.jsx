...
export default function NavbarSocial({ colorMode, mode }) {
  ...
  const getNavbarClasses = () => {
    ...
    // default
    return scrolling
      ? "bg-opacity-100 shadow-lg transition-all duration-1000 bg-bgSectionDark border-b-[1px] border-white"
        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? "w-[20%] tablet1:w-[20%] tablet2:w-[20%] desktop1:w-[30%] desktop2:w-[30%] transition-all duration-1000"
                  : "my-[20px] w-[40%] tablet1:w-[40%] tablet2:w-[40%] desktop1:w-[50%] desktop2:w-[50%] transition-all duration-1000"
              } tablet3:mb-0`}
            />
          </ScrollLink>
